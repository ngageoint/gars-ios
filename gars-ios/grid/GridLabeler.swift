...
public class GridLabeler: Labeler {
     ...
     * Default text size
     */
    public static let DEFAULT_TEXT_SIZE = GARSProperties.instance.doubleValue(PropertyConstants.LABELER, PropertyConstants.TEXT_SIZE)
    
    /**
     * Default buffer size
     */
    public static let DEFAULT_BUFFER = GARSProperties.instance.doubleValue(PropertyConstants.LABELER, PropertyConstants.BUFFER)
